...
public class TurnDegrees extends CommandBase {
  ...
  public void execute() {
    ...
    double targetAngle = m_angle + m_degrees;
    double sign = Math.signum(targetAngle - currentAngle);
    m_drive.arcadeDrive(0, sign * (.058 + (Math.abs(targetAngle - currentAngle)/180)));
  }
  ...
  public boolean isFinished() {
    ...
    */
    ...
    return Math.abs(targetAngle - currentAngle) < 1.0;
  }
